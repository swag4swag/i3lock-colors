    ...
    while ((o = getopt_long(argc, argv, optstring, longopts, &optind)) != -1) {
        switch (o) {
            ...
            case 'R': {
                ...
                if (strlen(arg) != 6 || sscanf(arg, "%06[0-9a-fA-F]", red) != 1)
                    errx(EXIT_FAILURE, "color is invalid, it must be given in 3-byte hexadecimal format: rrggbb\n");
            ...
            case 'G': {
                ...
                if (strlen(arg) != 6 || sscanf(arg, "%06[0-9a-fA-F]", green) != 1)
                    errx(EXIT_FAILURE, "color is invalid, it must be given in 3-byte hexadecimal format: rrggbb\n");
            ...
            case 'B': {
                ...
                if (strlen(arg) != 6 || sscanf(arg, "%06[0-9a-fA-F]", blue) != 1)
                    errx(EXIT_FAILURE, "color is invalid, it must be given in 3-byte hexadecimal format: rrggbb\n");
            ...
            case 'O': {
                ...
                if (strlen(arg) != 6 || sscanf(arg, "%06[0-9a-fA-F]", outline) != 1)
                    errx(EXIT_FAILURE, "color is invalid, it must be given in 3-byte hexadecimal format: rrggbb\n");
